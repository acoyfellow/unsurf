      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Record a browser session', slug: 'guides/record' },
            { label: 'Read a recorded session', slug: 'guides/observe' },
            { label: 'Loop until the North Star', slug: 'guides/loop' },
            { label: 'Private traces', slug: 'guides/privacy' },
