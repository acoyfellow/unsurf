...
The response lists the registered tools. The core set is `scout`, `worker`, and `heal`. Depending on server configuration, you may also see `gallery`, `directory`, and `agent-scout`.
